...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='gas_data/gas_datav5.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='yaml/hyp.scratch.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=100)
    parser.add_argument('--batch-size', type=int, default=80, help='total batch size for all GPUs')
    ...
    parser.add_argument('--adam', action='store_true', help='use torch.opti m.Adam() optimizer')
